...
**Note:** Those internal types in the square brackets are called "type parameters".  In this case, `str` is the type parameter passed to `list`.
...
**Note:** To learn more about [Pydantic, check its docs](https://pydantic.dev/docs/).
...
**Note:** If you already went through all the tutorial and came back to see more about types, a good resource is [the "cheat sheet" from `mypy`](https://mypy.readthedocs.io/en/latest/cheat_sheet_py3.html).
